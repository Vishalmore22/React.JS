    ...
    return (
        <div>
            ...
            <div className='container w-50'>
                <ul className='text-center mt-5 p-4 rounded-3 shadow gap-4 card bg-dark'>
                    ...
                    <li><input onChange={(e) => setUser({ ...user, password: e.target.value })} type="text" className='rounded-4 p-2 w-50 border-0 shadow bg-dark text-light' placeholder='Password' /></li>
                    ...
                    <div>
                        <i class="bi bi-google text-light m-3 fs-5"></i>
                        <i class="bi bi-apple text-light fs-5"></i>
                    </div>
